  ...
  return (
    <div className="max-w-screen-2xl mx-auto pt-20 px-4">
      ...
      <div className="flex justify-center space-x-4 mt-8">
        <Link
          to="/shop"
          className="text-white bg-black text-center text-xl font-normal tracking-[0.6px] leading-[72px] w-[200px] h-12 flex items-center justify-center max-md:text-base rounded-lg shadow hover:bg-gray-800 transition-colors"
        >
          Continue shopping
        </Link>
        <Link
